...
C {vsource.sym} -480 210 0 0 {name=Vin1 value="PULSE(0 1.8 \{t_start\} 5p 5p 19.99n 30n)" savecurrent=false}
...
C {code_shown.sym} 10 -150 0 0 {name=sim only_toplevel=false value=".param t_start=9.8n
.control
let N=29
let index=0
...
print tdq_vec tdc_vec tcq_vec > time_data_rise.txt
.endc"}
