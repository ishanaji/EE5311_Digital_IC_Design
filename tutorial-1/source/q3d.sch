...
C {vsource.sym} -130 70 0 0 {name=Vstep value="PULSE(1.8 0 5n 10p 10p)" savecurrent=false}
C {gnd.sym} -130 120 0 0 {name=l2 lab=0}
C {code_shown.sym} 290 30 0 0 {name=sim only_toplevel=false value=".ic v(Vout)=1.8
.control
  tran 1n 120n
  plot v(Vin) v(Vout)
  meas tran vout_20ns FIND v(Vout) AT=25n
  meas tran vout_100ns FIND v(Vout) AT=105n
.endc"}
...
C {sky130_fd_pr/pfet3_01v8.sym} 80 60 3 0 {name=M1
W=0.42
L=0.15
body=VDD
nf=1
